// "BRUNN" and "moritz-brunnmatt" Moritz
// "STUUEHL" and "mia-stuehle" Mia
// "BOODLE" and "luisa-doodle" Luisa
// "YOMICS" and "yoana-comics" Yoana

// Change the following parameters to customize the image generation
export const access_token = "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" // provided HuggingFace API token
